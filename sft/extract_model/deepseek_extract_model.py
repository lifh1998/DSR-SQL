...
class DeepseekForExtractLM(LlamaForCausalLM):
    """
    ...
    def set_tokenizer(self, tokenizer: LlamaTokenizer | LlamaTokenizerFast):
    ...
    def _generate_permutation_ids(
        ...
        # print("answer_ids:", answer_ids[:30])
        # print("len(self.answer_start_ids):", len(self.answer_start_ids))
        # print("self.answer_start_ids:", self.answer_start_ids)
